<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('https://cdn.pixabay.com/photo/2015/04/10/00/41/food-715542_960_720.jpg');">
        <h1
            class="font-mono text-3xl mx-auto  font-extrabold text-transparent bg-clip-text md:text-center sm:leading-none lg:text-5xl">
            <span class="inline rounded-md px-4 py-4 mx-auto whitespace-nowrap text-rose-300 max-w-min bg-emerald-900  md:block">Welcome To LaraRestaurant</span>
        </h1>
        <div class="mx-auto mt-5 rounded-md max-w-min px-2 py-2 text-center whitespace-nowrap text-green-50 bg-emerald-900 md:text-center lg:text-lg">
    ...
    <section class="px-2 py-32 bg-amber-200 md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <h2 class="text-5xl font-bold text-rose-300">Welcome</h2>
                        <!-- </h1> -->
                        ...
                        <div class="relative flex">
                            <a href="#_"
                                class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-emerald-900 rounded-md sm:mb-0 hover:bg-green-700 sm:w-auto">
                                Read More
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl shadow-emerald-900 sm:rounded-xl">
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <h2
                            class="mb-4 text-3xl font-bold text-transparent bg-clip-text dark:text-rose-300">
                            WHY CHOOSE US?</h2>
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            ...
            <h2 class="text-3xl font-bold text-transparent bg-clip-text dark:text-rose-300">
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                @foreach ($specials->menus as $menu)
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        ...
                        <div class="px-6 py-4">
                            <h4 class="mb-3 text-xl font-semibold tracking-tight text-emerald-900 uppercase">
                                {{ $menu->name }}</h4>
